...
export function formAuthentication() {
  ...
  `;
    ...
    formRegister.onsubmit = async (e) => {
        ...
        const utente = {
            id: 0,
            nome: (formRegister.querySelector("#registerName")).value,
            username: (formRegister.querySelector("#registerUsername")).value,
    ...
    formSign.onsubmit = async (e) => {
        ...
        AuthController.login((formSign.querySelector("#loginName")).value, (formSign.querySelector("#loginPassword")).value).then((res) => {
            if (res.success)
                location.reload();
        });
    };
